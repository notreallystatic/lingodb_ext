 ...
 *	  specified tag.
 *
 * !WARNING!: Avoid using lingodbNewNode directly. You should be using the
...
#define lingodbNewNode(size, tag)                                       \
   ({                                                                   \
      Node* _result;                                                    \
...
#define makeNode(_type_) ((_type_*) lingodbNewNode(sizeof(_type_), T_##_type_))
